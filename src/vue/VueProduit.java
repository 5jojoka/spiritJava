...
public class VueProduit extends JFrame implements ActionListener
{
	...
	public VueProduit ()
	{
		...
		this.panelAjout.add(new JLabel("Temps de preparation :"));
		...
		this.uneTable.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				if (e.getClickCount() >=2) {
					...
					txtPrix.setText(unTableau.getValueAt(ligne, 2).toString());	//set
	...
	public Object [] [] getDonnees(String mot) {
		...
		//transformation des Produits en matrice de données
	...
	public void updateProduit() {
		...
		if (prix >=0 ) {
			...
			Produit unProduit = new Produit(id_produit,nom, prix, tpsPreparation);
	...
	public void insertProduit() {
		...
		{
			JOptionPane.showMessageDialog(this,"Attention au format du prix !");
			prix = -1 ;
		}
		if (prix >=0 )
		{
			...
			unProduit = Main.selectWhereProduit(nom, prix);
